...
try {
  ...
  /// let (or const) ///
 // her satte jeg const til linje 24 da denne er forventet til å alltid vøre 1
  // linje 27 valgte jeg å bruke let da denne verdgien kan forandres i seinere kode
  ...
  /// Template strings ///
// her forandret jeg kode linja til "Hello " + who + "! " + addOne(2) + " times.";
  // det denne sier er at den skal printe ut hello world 3 ganger. trikset her var å legge til addon(2) da den gjør dette 2 ganger etter første gang
  ...
  /// Property shorthand ///
//her samlet jeg alt på en linje for å få de verdiene jeg ville ha
  ...
  //her brukte jeg spread med parangteser for å skaffe 1
  ...
  //her gjorde jeg om på rekefølgen og brukte spread for å få de verdiene jeg ville ha
